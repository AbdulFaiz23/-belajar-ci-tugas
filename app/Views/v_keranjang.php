...
?>
<?php echo form_open('v_keranjang/edit') ?>
    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url('v_keranjang/delete/' . $item['rowid'] . '') ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
        <?php
            endforeach;
...
<a class="btn btn-warning" href="<?php echo base_url() ?>v_keranjang/clear">Kosongkan Keranjang</a>
<?php if (!empty($items)) : ?>
